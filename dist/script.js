...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2022-08-18T00:00:00');
...
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/es.object.from-entries */ "./node_modules/core-js/modules/es.object.from-entries.js");
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_5__);
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function _callee(e) {
      var data, objectData, jsondata;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              objectData = Object.fromEntries(data);
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      if (item == undefined) {
        ...
        listener = item.addEventListener('click', function (e) {
          if (e.target) {
            e.preventDefault();
          }
...
var tabs = function tabs(parentSelector, tabButtonSelector, activeClass, tabsContentSelector) {
  ...
  tabsButtonsParentSelector.addEventListener('click', function (e) {
    ...
    if (e.target.classList.contains(tabButtonSelector.replace(/\./g, "")) || e.target.parentElement.classList.contains(tabButtonSelector.replace(/\./g, ""))) {
      tabButton.forEach(function (item, i) {
...
var timer = function timer(date) {
  ...
  function countDelta() {
    var t = Date.parse(expireDate) - Date.parse(new Date());
  ...
  var timerWidget = document.querySelector('.container1'),
